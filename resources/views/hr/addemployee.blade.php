...
<html lang="en">
  ...
  <form class="contact" action="{{ route('hr.empcreate') }}" method="POST" enctype="multipart/form-data">
    @csrf
    <u><h3 style="margin-top:5%;margin-left:35%;">ADD EMPLOYEE</h3></u>
  ...
  <div class="row mb-3"style="margin-left:15%;">
    ...
    <div class="col-sm-6">
      <input type="file" class="form-control" id="inputname3" name="image">
    </div>
  </div>
