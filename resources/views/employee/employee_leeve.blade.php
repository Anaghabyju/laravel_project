...
<html lang="en">
  ...
  <form class="contact" action="{{ route('employee.leevecreate') }}" method="POST">
    @csrf
    ...
    <div class="col-sm-6">
      ...
      <input type="text" required class="form-control" id="inputname3" name="typeofleeve" value="{{$data[0]->typeofleeve }}">
    </div>
    </div>
